...
{
	{
		...
		bool L_2 = ___2_ownsHandle;
		int32_t L_3 = ___3_bufferSize;
		FileStream__ctor_m13836A33E03714476B2CEA7917B80ECD70A8F5E9(__this, L_0, L_1, L_2, L_3, (bool)0, (bool)0, NULL);
		return;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FileStream__ctor_m13836A33E03714476B2CEA7917B80ECD70A8F5E9 (FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8* __this, intptr_t ___0_handle, int32_t ___1_access, bool ___2_ownsHandle, int32_t ___3_bufferSize, bool ___4_isAsync, bool ___5_isConsoleWrapper, const RuntimeMethod* method) 
...
IL_002b:
	{
		bool L_5;
		L_5 = VirtualFuncInvoker0< bool >::Invoke(10, __this);
		if (L_5)
		{
			goto IL_003e;
		}
...
IL_0079:
	{
		int64_t L_17;
		L_17 = VirtualFuncInvoker0< int64_t >::Invoke(12, __this);
	...
	}
	{
		...
		VirtualActionInvoker1< int64_t >::Invoke(13, __this, L_19);
	}
	...
	{
		{
			...
			int32_t L_12 = ((Exception_t*)((IOException_t5D599190B003D41D45D4839A9B6B9AB53A755910*)IL2CPP_GET_ACTIVE_EXCEPTION(IOException_t5D599190B003D41D45D4839A9B6B9AB53A755910*)))->____HResult;
			if ((!(((uint32_t)L_12) == ((uint32_t)((int32_t)-2147024816)))))
			{
				goto IL_0077;
			}
		}
...
CATCH_007b:
	{
		{
			V_6 = ((UnauthorizedAccessException_t8FC1F1DE7AA62456E9E25EFDFC658A623A626791*)IL2CPP_GET_ACTIVE_EXCEPTION(UnauthorizedAccessException_t8FC1F1DE7AA62456E9E25EFDFC658A623A626791*));
			int32_t L_15 = V_4;
			int32_t L_16 = L_15;
			V_4 = ((int32_t)il2cpp_codegen_add(L_16, 1));
			if ((((int32_t)L_16) <= ((int32_t)((int32_t)65536))))
			{
				goto IL_009a;
			}
		}
		{
			UnauthorizedAccessException_t8FC1F1DE7AA62456E9E25EFDFC658A623A626791* L_17 = V_6;
			NullCheck(L_17);
			String_t* L_18;
			...
			IOException__ctor_mFA9F39D1AF43FBC40BFA68A7BFE07852D1EF8B1B(L_20, L_18, L_19, NULL);
			IL2CPP_RAISE_MANAGED_EXCEPTION(L_20, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&Path_GetTempFileName_m37ED1D583641F01CEB2CB5E1B8928F9EC06D7660_RuntimeMethod_var)));
		}
...
IL_009c:
	{
		FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8* L_21 = V_0;
		if (!L_21)
		{
			goto IL_0017;
		}
	}
	{
		...
		NullCheck(L_22);
		VirtualActionInvoker0::Invoke(19, L_22);
		String_t* L_23 = V_1;
		return L_23;
	}
}
...
IL_0040:
	{
		bool L_12;
		L_12 = Environment_get_IsRunningOnWindows_mD7ACC63C758C5EB6A3DA0542D7F0113B58F4C692(NULL);
		if (!L_12)
		{
			goto IL_005f;
		}
	...
	{
		String_t* L_17 = ___1_parameterName;
		ArgumentException_tAD90411542A20A9C72D5CDA3A84181D8B947A263* L_18 = (ArgumentException_tAD90411542A20A9C72D5CDA3A84181D8B947A263*)il2cpp_codegen_object_new(((RuntimeClass*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&ArgumentException_tAD90411542A20A9C72D5CDA3A84181D8B947A263_il2cpp_TypeInfo_var)));
		ArgumentException__ctor_m026938A67AF9D36BB7ED27F80425D7194B514465(L_18, L_17, NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_18, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&Path_Validate_m1D9EA20556CA4DBA21A46E686219F317D0A49D51_RuntimeMethod_var)));
	}
